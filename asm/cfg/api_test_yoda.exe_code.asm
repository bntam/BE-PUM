...
0x00406aba:	je 0x00406b2a
0x00406b2a:	pushl %esi
0x00406b2b:	movl %edx, %ebp
0x00406b2d:	addl %edx, $0x42725b<UINT32>
0x00406b33:	call CloseHandle@Kernel32.dll
0x00406b35:	ret
