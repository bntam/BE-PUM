...
0x004024b7:	je 0x0040253f
0x0040253f:	popl %ecx
0x00402540:	call 0x00402545
0x00402545:	popl %edx
0x00402546:	movl %eax, (%esi)
0x00402548:	addl %esp, $0x1c<UINT8>
0x0040254b:	popl %edi
0x0040254c:	addl %esp, $0x2a<UINT8>
0x0040254f:	pushl %edi
0x00402550:	btrl %eax, $0x1f<UINT8>
0x00402554:	jb 11
0x00402556:	addl %eax, %ebp
0x00402558:	pushl %eax
0x00402559:	leal %edi, 0x3c(%edx)
0x0040255f:	jmp 0x00402568
0x00402568:	pushl %edi
0x00402569:	andw %di, $0xfffff000<UINT16>
0x0040256e:	pushl %edi
0x0040256f:	call wsprintfA@user32.dll
wsprintfA@user32.dll: API Node	
0x00402575:	addl %esp, $0x10<UINT8>
0x00402578:	movl %edx, %edi
0x0040257a:	movl %eax, %ebx
0x0040257c:	jmp 0x00402408
0x00402408:	jmp 0x004040e2
0x004040e2:	addl %esp, $0xc<UINT8>
0x004040e5:	pushl $0x10<UINT8>
0x004040e7:	movl %ebx, %eax
0x004040e9:	addw %ax, $0xfa<UINT16>
0x004040ed:	pushl %eax
0x004040ee:	pushl %edx
0x004040ef:	pushl $0x0<UINT8>
0x004040f1:	movl %ebx, (%ebx)
0x004040f3:	call MessageBoxA@user32.dll
MessageBoxA@user32.dll: API Node	
0x004040f5:	pushl $0xffffffff<UINT8>
0x004040f7:	call ExitProcess@kernel32.dll
