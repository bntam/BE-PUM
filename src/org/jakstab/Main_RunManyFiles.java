...
public class Main_RunManyFiles {
			...
			while (line != null) {
				...
				// && tFileList.containFN(line)
					...
					try {
						...
						System.out.println("File Name:" + program.getFileName());
						// Processing Time
						...
						System.out.println("Instructions: " + String.format("%8d", program.getInstructionCount()));
						...
						rFile.appendFile(line + "\t" + runtime + "\t" + graphWriter.getNodesCount() + "\t"
								+ graphWriter.getEdgesCount() + "\t" + Program.getProgram().getTechnique());
	...
	private static String getExtractBaseFileName(String baseFileName) {
		...
		String r = baseFileName.replace("vx.netlux.org", "ProcessResults_VMCAI_Win32");
