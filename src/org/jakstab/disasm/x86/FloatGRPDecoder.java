...
public class FloatGRPDecoder extends FPInstructionDecoder {
	...
	private final static Logger logger = Logger
			.getLogger(FloatGRPDecoder.class);
	...
	private static final FPInstructionDecoder floatGRPMap[][] = {
			/* d9_2 */
			{ new FPInstructionDecoder("fnop"), null, null, null, null, null,
					null, null },
			/* d9_4 */
			{ new FPInstructionDecoder("fchs"),
					new FPInstructionDecoder("fabs"), null, null,
					new FPInstructionDecoder("ftst"),
					new FPInstructionDecoder("fxam"), null, null },
			/* d9_5 */
			{ new FPInstructionDecoder("fld1"),
					...
					new FPInstructionDecoder("fldz"), null },
			/* d9_6 */
			...
			/* da_5 */
			{ null, new FPInstructionDecoder("fucompp", ADDR_FPREG, 1), null,
			...
			{ new FPInstructionDecoder("feni(287 only)"),
					...
					new FPInstructionDecoder("fNsetpm(287 only)"), null, null,
					null },
			/* de_3 */
			{ null, new FPInstructionDecoder("fcompp"), null, null, null, null,
					null, null },
			/* df_4 */
			{ new FPInstructionDecoder("fNstsw", ADDR_REG, AX), null, null,
					null, null, null, null, null } };
