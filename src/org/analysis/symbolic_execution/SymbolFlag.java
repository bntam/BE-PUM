...
public class SymbolFlag {
	...
	public void changeFlagWithCMP(SymbolValueRegister symbolValueRegister,
		...
		if (dest instanceof AnyExp || source instanceof AnyExp) {
			...
			// R_SF:bool = high:bool(T_t_84:u32)
			sFlag = new HybridExp(t, "<", new LongValue(0));
			// sFlag = t;

			// R_ZF:bool = 0:u32 == T_t_84:u32
			zFlag = new HybridExp(t, "=", new LongValue(0));
		}
	}
	...
	public void changeFlagWithADD(SymbolValueRegister symbolValueRegister,
		...
		HybridExp oc1 = new HybridExp(dest, "<", new LongValue(0));
		HybridExp oc2 = new HybridExp(source, "<", new LongValue(0));
		HybridBooleanExp oc3 = new HybridBooleanExp(oc1, "and", oc2);

		HybridExp oc4 = new HybridExp(t, ">=", new LongValue(0));
		HybridExp oc5 = new HybridExp(source, "<", new LongValue(0));
		HybridExp oc6 = new HybridExp(dest, "<", new LongValue(0));
	...
	public void changeFlagWithOR(SymbolValueRegister symbolValueRegister,
		...
		if (dest instanceof LongValue && source instanceof LongValue) {
			long d = ((LongValue) dest).getValue();
			long s = ((LongValue) source).getValue();
	...
	public void changeFlagWithINC(Value dest) {
		this.changeFlagWithADD(dest, new LongValue(1));
