...
public class APIK32Implementation implements APIK32{
	...
	@Override
	public boolean CopyFileA(String existingFileName, String newFileName,
			boolean failIfExists) {
		// TODO Auto-generated method stub
		/**
		 * existingFileName: the path of existing file, example: D:/WORKSPACE/Eclipse/VirusAPI/old.txt
		 * newFileName: the path of new file, example: D:/WORKSPACE/Eclipse/VirusAPI/new.txt
		 * failIfExists = TRUE:  file existed -> Failed to copy
		 * failIfExists = FALSE: file existed -> Replace old file
		 */
	...
	public String GetCommandLine() {
		// TODO Auto-generated method stub
		/**
		 * cmdLine: get program name
		 * cmdArg: get input arguments that called by main
		 */
	...
	public int GetWindowsDirectory(AtomicReference<String> dirBuffer, int bufferSize) {
		// TODO Auto-generated method stub
		/**
		 * dirBuffer: string buffer which contains directory
		 * bufferSize: size of buffer, it means length of string
		 */
	...
	public int GetCurrentDirectory(int bufferLength, AtomicReference<String> dirBuffer) {
		...
		/**
		 * dirBuffer: string buffer which contains directory
		 * bufferLength: length of buffer, it means length of string
		 */
	...
	@Override
	public SearchHandle FindFirstFile(String fileName,
			AtomicReference<WIN32_FIND_DATA> findFileData) {
		// TODO Auto-generated method stub
		/**
		 * fileName: name of file which we want to find
		 * findFileData: find data 
		 * dirSearch: directory where we want to find file
		 * searchContent: content which contains file name and file type
		 */
	...
	@Override
	public boolean FindNextFile(SearchHandle searchHandle,
			AtomicReference<WIN32_FIND_DATA> findFileData) {
		// TODO Auto-generated method stub
	...
	public void GetSystemTime(AtomicReference<SYSTEM_TIME> systemTime) {
		...
		SYSTEM_TIME newSystemTime = new SYSTEM_TIME(year, month, dayOfMonth,dayOfWeek, hour, minute, second, milisecond);
		systemTime.set(newSystemTime);
	}
	
	@Override
	public FileHandle CreateFile(String fileName, DesiredAccess desiredAccess,
			ShareMode shareMode, SECURITY_ATTRIBUTES securityAttributes,
		...
		// Create new file on specified directory,set attribute, share mode for file
		// TODO:
