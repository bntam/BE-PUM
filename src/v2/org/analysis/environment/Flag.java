...
public class Flag {
    ...
    // PHONG: fix here
    public void changeFlagWithNeg(Value dest, Value source, Environment env, int numBits) {
        changeFlagWithSUB(dest, source, env, numBits);
        if (((LongValue) source).getValue() == 0x0) {
            cFlag = new BooleanValue(false);
        } else cFlag = new BooleanValue(true);
    }

    public void changeFlagWithADC(Value dest, Value source, int cf,
                                  Environment env, int numBits) {
        ...
        if (dest instanceof AnyValue || source instanceof AnyValue) {
            ...
            // *1* %CF := ((op1 < 0) & (op2 < 0))
            // | ((result >= 0) & ((op1 < 0) | (op2 < 0)))
            HybridBooleanValue oc1 = new HybridBooleanValue(dest, "<",
                    new LongValue(0));
            HybridBooleanValue oc2 = new HybridBooleanValue(source, "<",
                    new LongValue(0));
            ...
            HybridBooleanValue o4 = new HybridBooleanValue(o1, "and",
                    new HybridBooleanValue(o2, "and", o3));
            ...
            HybridBooleanValue o8 = new HybridBooleanValue(o5, "and",
                    new HybridBooleanValue(o6, "and", o7));
    ...
    public void changeFlagWithSBB(Value dest, Value source, int cf,
                                  Environment env, int numBits) {
        if (dest == null || source == null)
            return;
    ...
    public void changeFlagWithADD(Value dest, Value source, Environment env,
                                  int numBits) {
        if (dest == null || source == null)
            return;
    ...
    public void changeFlagWithAND(Value dest, Value source, Environment env,
                                  int numBits) {
    ...
    public void changeFlagWithCMP(Value dest, Value source, Environment env,
                                  int numBits) {
    ...
    public void changeFlagWithDEC(Value dest, Environment env, int numBits) {
        ...
        if (dest instanceof AnyValue || source instanceof AnyValue) {
			 ...
			 * HybridBooleanValue(source, "<", new LongValue(0)); HybridBooleanValue
			 * oc3 = new HybridBooleanValue(oc1, "and", oc2);
			 */
    ...
    public void changeFlagWithDIV(Value dest, Value source, Environment env,
                                  int numBits) {
...
/*		if (dest instanceof AnyValue || source instanceof AnyValue) {
			...
			long d = ((LongValue) dest).getValueOperand();
			long s = ((LongValue) source).getValueOperand();
    ...
    public void changeFlagWithOR(Value dest, Value source, Environment env,
                                 int numBits) {
        // AND, OR, and XOR clear OF and CF, leave AF undefined, and update SF,
        // ZF, and PF.
        // http://css.csail.mit.edu/6.858/2010/readings/i386/s03_04.htm
    ...
    public void changeFlagWithRL(Value registerValue, Value x, Environment env,
                                 int numBits) {
        // TODO Auto-generated method stub

    }

    public void changeFlagWithRR(Value registerValue, Value x, Environment env,
                                 int numBits) {
        // TODO Auto-generated method stub
    ...
    public void changeFlagWithSUB(Value dest, Value source, Environment env,
                                  int numBits) {
        if (dest == null || source == null)
            return;
    ...
    public void changeFlagWithTEST(Value d, Value s, Environment env,
                                   int numBits) {
        // TODO Auto-generated method stub
        this.changeFlagWithAND(d, s, env, numBits);
    }

    public void changeFlagWithXOR(Value dest, Value source, Environment env,
                                  int numBits) {
        // AND, OR, and XOR clear OF and CF, leave AF undefined, and update SF,
        // ZF, and PF.
        // http://css.csail.mit.edu/6.858/2010/readings/i386/s03_04.htm
    ...
    /*public long convertSignedValue(long value, int numBits) {
    ...
    public boolean equal(Flag f) {
        return cFlag.equal(f.getCFlag()) && oFlag.equal(f.getOFlag())
                && sFlag.equal(f.getSFlag()) && zFlag.equal(f.getZFlag());
    }
   ...
   /* private boolean getParityBit(long t) {
        // TODO Auto-generated method stub
    ...
    public String toString() {
        return "cf=" + cFlag.toString() + ", " + "pf=" + pFlag.toString()
                + ", " + "af=" + aFlag.toString() + ", " + "zf="
                + zFlag.toString() + ", " + "sf=" + sFlag.toString() + ", "
                + "tf=" + tFlag.toString() + ", " + "df=" + dFlag.toString()
                + ", " + "of=" + oFlag.toString() + ", " + "if="
                + iFlag.toString();
    }

    public void changeFlagWithIMUL(Value dest, Value source, Environment env,
                                   int numBits) {
        // TODO Auto-generated method stub
    ...
    public void changeFlagWithMUL(Value dest, Value source, Environment env,
                                  int numBits) {
        // TODO Auto-generated method stub
        // The SF, ZF, AF, and PF flags are undefined
    ...
    public void changeFlagWithSHL(Value dest, Value source, Environment env,
                                  int numBits) {
        ...
        if (dest instanceof AnyValue || source instanceof AnyValue) {
            ...
            if (s != 0) {
                ...
                if (s == 2) {
                    ...
                    oFlag = new BooleanValue(((BooleanValue) cFlag).getValue()
                            ^ getMSB(d * s, numBits));
                } else
                    oFlag = new BooleanValue(false);
    ...
    public void changeFlagWithSAL(Value dest, Value source, Environment env,
                                  int numBits) {
        // The CF flag contains the value of the last bit shifted out of the
        // destination operand;
        // it is undefined for SHL and SHR instructions where the count is
    ...
    public void changeFlagWithSHR(Value dest, Value source, Environment env,
                                  int numBits) {
        // The CF flag contains the value of the last bit shifted out of the
        // destination operand;
        // it is undefined for SHL and SHR instructions where the count is
        ...
        if (dest instanceof AnyValue || source instanceof AnyValue) {
            ...
            long t = d / s;
            cFlag = new BooleanValue(checkLSB(d,
                    ((LongValue) source).getValue(), numBits));
    ...
    public void changeFlagWithSAR(Value dest, Value source, Value result, Environment env,
                                  int numBits) {
        // The CF flag contains the value of the last bit shifted out of the
        // destination operand;
        // it is undefined for SHL and SHR instructions where the count is
    ...
    public Value getEFLAGS() {
        ...
        long ret = cf + 2 + 4*pf + 16*af + 64*zf + 128*sf + 256*tf + 512*ifl
                + 1024*df + 2048*of;
