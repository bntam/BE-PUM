...
public class PEB {
    ...
    static void updatePEB(BPState curState){
        ...
        curState.getEnvironement().getMemory().setByteMemoryValue(PEB_Base_Address, new LongValue(InheritedAddressSpace));
        // Update PEB_1
        ReadImageFileExecOptions = 0;
        curState.getEnvironement().getMemory().setByteMemoryValue(PEB_Base_Address + 1, new LongValue(ReadImageFileExecOptions));
        // Update PEB_2
        BeingDebugged = 1;
        ...
        curState.getEnvironement().getMemory().setDoubleWordMemoryValue(PEB_Base_Address + 8, new LongValue(ImageBaseAddress));
        // Update PEB_C
