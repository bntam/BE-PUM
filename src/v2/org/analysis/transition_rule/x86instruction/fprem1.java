...
public class fprem1 extends X86InstructionStub {
	...
	public static void FPREM1(double st0, double st1, Environment env){		
...
//			ST(0) = ST(0) - (ST(1) * QQ * 2(D - N));
	...
	public static int round(double d) {		
		...
		int result = Integer.valueOf(temp.intValue());
		return result;
	}
