...
public class Kernel32Stub extends APIStub {
	...
	private void simulateAPI(AbsoluteAddress address, String funcName, BPState curState, Instruction inst) {
		...
		// + " " + x5 + " " + x6 + " " + x7);
		//
		// if (x1 instanceof LongValue && x2 instanceof LongValue && x3
		// instanceof LongValue
		// && x4 instanceof LongValue && x5 instanceof LongValue && x6
		// instanceof LongValue
		...
		// // String str = symbolValueMemoryOperand.getText(new
		// // X86MemoryOperand(DataType.INT32, t2));
		// System.out.println("Flag:" + t1 + ", Source:" + t2 +
		// ", Message Field:" + t3 + ", Language:" + t4
		...
		// // String str = symbolValueMemoryOperand.getText(new
		// // X86MemoryOperand(DataType.INT32, t2));
		// System.out.println("File Handle:" + t1 + ", Time Created:" + t2 +
		// ", Time Access:" + t3
		// + ", Time Written :" + t4);
		//
		// System.out.println("Return Value: " + 1);
		...
		// System.out.println("Return Value: " + 1);
		// register.mov("eax", new LongValue(1));
		// memory.setMemoryValue(new X86MemoryOperand(DataType.INT32, t2), new
		// LongValue(0), inst);
		// }
		//
		...
		// // String str = symbolValueMemoryOperand.getText(new
		// // X86MemoryOperand(DataType.INT32, t2));
		// System.out.println("Old Protect:" + t1 + ", New Protect:" + t2 +
		// ", Size:" + t3 + ", Address :" + t4);
		//
		// System.out.println("Return Value: " + 1);
		// register.mov("eax", new LongValue(1));
		...
		// * program);
		// */
		// String commandLine = memory.getText(new
		// X86MemoryOperand(DataType.INT32, ((LongValue) x1).getValue()));
		// System.out.println("Command Line:" + commandLine + ", Window Style:"
		...
		// && x4 instanceof LongValue && x5 instanceof LongValue && x6
		// instanceof LongValue
		// && x7 instanceof LongValue && x8 instanceof LongValue && x9
		// instanceof LongValue
		...
		//
		// String moduleFileName = memory.getText(new
		// X86MemoryOperand(DataType.INT32, t1));
		// String commandLine = memory.getText(new
		// X86MemoryOperand(DataType.INT32, t2));
		// String curDir = memory.getText(new X86MemoryOperand(DataType.INT32,
		// t8));
		// String pStarupInfo = memory.getText(new
		// X86MemoryOperand(DataType.INT32, t9));
		// System.out.println("Module File Name:" + moduleFileName +
		// ", Command Line:" + commandLine
		// + ", Process Attribute Security:" + t3 +
		// ", Thread Attribute Security:" + t4 + ", Handle Flag:"
		// + t5 + ", Creation Flag:" + t6 + ", Environemnt Block:" + t7 +
		// ", Current Directory:" + curDir
		// + ", Process Starup Info:" + pStarupInfo + ", Process Information:" +
		// t10);
		// register.mov(
		// "eax",
		// new LongValue(system.getProcessHandle().createProcess(moduleFileName,
		// commandLine, t3, t4, t5,
		...
		//
		// if (x1 instanceof LongValue) {
		// String fName = memory.getText(new X86MemoryOperand(DataType.INT32,
		...
		// * program);
		// */
		// String functionName = memory.getText(new
		// X86MemoryOperand(DataType.INT32, ((LongValue) x2).getValue()));
		...
		// else
		// t = system.getProcAddress(((LongValue) x1).getValue(), ((LongValue)
		// x2).getValue());
		// register.mov("eax", new LongValue(t));
		// System.out.println("Return Value: " + t);
		//
		...
		// */
		// String libraryName = memory.getText(new
		// X86MemoryOperand(DataType.INT32, ((LongValue) x1).getValue()));
		...
		// // String str = symbolValueMemoryOperand.getText(new
		// // X86MemoryOperand(DataType.INT32, t2));
		// System.out.println("Handle File:" + t1 + ", Number of Bytes:" + t2 +
		// ", Address of High-Order:" + t3
		// + ", Move Type:" + t4);
		// register.mov("eax", new
		// LongValue(system.getFileHandle().setFilePointer(t1, t2, t3, t4)));
		// }
		//
		...
		//
		// register.mov("eax", new
		// LongValue(system.getFileHandle().closeFind(t)));
		// }
		//
		...
		// ((LongValue) x1).getValue()));
		// register.mov("eax", new
		// LongValue(system.getFileHandle().deleteFile(fName)));
		// }
		//
		...
		// + t3 + ", Low-order 32 bits of file offset :" + t4 +
		...
		// // String str = symbolValueMemoryOperand.getText(new
		// // X86MemoryOperand(DataType.INT32, t2));
		// System.out.println("Handle File:" + t1 + ", Address of Buffer:" + t2
		// + ", Number of Byte:" + t3
		...
		// long t5 = ((LongValue) x5).getValue();
		//
		// String str = memory.getText(new X86MemoryOperand(DataType.INT32,
		// t2));
		// System.out.println("Handle File:" + t1 + ", String written:" + str +
		// ", Number of Byte:" + t3
		// + ", Pointer:" + t4 + ", Overlapped:" + t5);
		// register.mov("eax", new
		// LongValue(system.getFileHandle().writeFile(t1, str, t3, t4, t5)));
		// }
		...
		// register.mov("eax", new
		// LongValue(system.getFileHandle().setEndOfFile(t1)));
		// }
		//
		...
		// String str = memory.getText(new X86MemoryOperand(DataType.INT32,
		// t2));
		// String str1 = memory.getText(new X86MemoryOperand(DataType.INT32,
		// t1));
		// System.out.println("Handle Window:" + t1 + " " + str1 +
		// ", Post Message:" + str + ", First Param:" + t3
		// + ", Second Param:" + t4);
		// register.mov("eax", new
		// LongValue(system.getWindowHandle().postMessage(t1, str, t3, t4)));
		// }
		//
		...
		// String dest = memory.getText(new X86MemoryOperand(DataType.INT32,
		// ((LongValue) x1).getValue()));
		// String src = memory.getText(new X86MemoryOperand(DataType.INT32,
		// ((LongValue) x2).getValue()));
		...
		// ((LongValue) x2).getValue()));
		// // dest += src;
		// System.out.println("Destination String:" + dest + ", Source String:"
		// + src);
		// // symbolValueMemoryOperand.setText(new
		...
		// long t2 = ((LongValue) x2).getValue();
		//
		// String fileNameOld = memory.getText(new
		// X86MemoryOperand(DataType.INT32, t1));
		// String fileNameNew = memory.getText(new
		// X86MemoryOperand(DataType.INT32, t2));
		// System.out.println("Old File:" + fileNameOld + ", New File:" +
		// fileNameNew);
		//
		// register.mov("eax", new
		// LongValue(system.getFileHandle().moveFile(fileNameOld,
		// fileNameNew)));
		//
		// }
		//
		...
		// // String str = symbolValueMemoryOperand.getText(new
		// // X86MemoryOperand(DataType.INT32, t2));
		// String msg = memory.getText(new X86MemoryOperand(DataType.INT32,
		// t2));
		//
		// System.out.println("Window Handle:" + t1 + ", Message Sent:" + msg +
		// ", First Param:" + t3
		// + ", Second Param:" + t4);
		// register.mov("eax", new
		// LongValue(system.getWindowHandle().sendMessage(t1, msg, t3, t4)));
		// }
		//
		// } else
		// // insert API them
		...
		//
		// register.mov("eax", new
		// LongValue(system.getFileHandle().copyFile(fileNameOld, fileNameNew,
		// t3)));
		//
		// }
		//
		...
		// * program);
		// */
		// String className = memory.getText(new
		// X86MemoryOperand(DataType.INT32, ((LongValue) x1).getValue()));
		//
		// String windowName = memory.getText(new
		// X86MemoryOperand(DataType.INT32, ((LongValue) x2).getValue()));
		// System.out.println("Class Name:" + className +
		// ", Window Name Address:" + ((LongValue) x2).getValue()
		// + ", Window Name:" + windowName);
		// register.mov("eax",
		// new LongValue(system.getWindowHandle().findWindow(className,
		// ((LongValue) x2).getValue())));
		//
		// }
		//
		...
		// new LongValue(env.getSystem().getSTDHandle(((LongValue)
		// x1).getValue())));
		//
		...
		//
		// register.mov("eax", new
		// LongValue(system.getHeapHandle().creatHeap(t2, t3, t1)));
		//
		// }
		...
		// String src = memory.getText(new X86MemoryOperand(DataType.INT32,
		// ((LongValue) x2).getValue()));
		// System.out.println("Destination Address:" + dest + ", Source String:"
		// + src);
		...
		// + memory.getText(new X86MemoryOperand(DataType.INT32, ((LongValue)
		// x2).getValue())));
		// }
		//
		// if (x3 instanceof LongValue) {
		// System.out.print(", Address of Title Text:" + x3.toString() +
		// ", Title Text:"
		// + memory.getText(new X86MemoryOperand(DataType.INT32, ((LongValue)
		// x3).getValue())));
		// }
		...
		// long t2 = ((LongValue) x2).getValue();
		//
		// String searchName = memory.getText(new
		// X86MemoryOperand(DataType.INT32, t1));
		// System.out.println("Search File:" + searchName + ", Memory Operand:"
		// + t2);
		//
		// /*
		...
		// */
		// long t = system.getFileHandle().findFirstFile(searchName, memory,
		// t2);
		...
		// long t1 = ((LongValue) x1).getValue();
		//
		// String path = memory.getText(new X86MemoryOperand(DataType.INT32,
		// t1));
		...
		// // String str = symbolValueMemoryOperand.getText(new
		// // X86MemoryOperand(DataType.INT32, t2));
		// System.out.println("Handle File:" + t1 + ", Security Attribute:" + t2
		// + ", Object Protection:" + t3
		// + ", High-Order:" + t4 + ", High-Order:" + t5 +
		// ", File Mapping Name Address:" + t6);
		// long t = system.getFileHandle().createFileMapping(t1, t2, t3, t4, t5,
		// t6);
		// register.mov("eax", new LongValue(t));
		// System.out.println("Return Value:" + t);
		// }
		...
		// long t6 = ((LongValue) x6).getValue();
		// long t7 = ((LongValue) x7).getValue();
		// String fileName = memory.getText(new X86MemoryOperand(DataType.INT32,
		// t1));
		// System.out.println("FileName:" + fileName + ", Access:" + t2 +
		// ", ShareMode:" + t3 + ", pSecurity:"
		...
		// Value x1 = stack.pop();
		// Value x2 = stack.pop();
		// System.out.println("Argument: Length:" + x1 + ", Memory Operand:" +
		// x2);
		// if (x1 instanceof LongValue && x2 instanceof LongValue) {
		// String curDir = "C:/Test";
		// long size = memory.setText(new X86MemoryOperand(DataType.INT32,
		...
		// // symbolStack.pop();
		// } else {
		// String libraryName = env.getMemory().getText(((LongValue)
		// lpModuleName).getValue());
		// System.out.println("Library Name: " + libraryName);
		//
		...
		//
		// if (hModule instanceof LongValue && lpFilename instanceof LongValue
		...
		// if (hFile instanceof LongValue && lOffset instanceof LongValue &&
		// iOrigin instanceof LongValue) {
		// register.mov("eax", new SymbolValue("api_eax"));
		// }
		...
		// System.out.println("Argument:" + lstrStart.toString() + " " +
		// lstrCur.toString());
		...
		// System.out.println("Argument:" + fileTime1.toString() + " " +
		// fileTime2.toString());
		...
		// System.out.println("Argument:" + locale.toString() + " " +
		// cmpFlags.toString() + " " + string1.toString()
		// + " " + count1.toString() + string2.toString() + " " +
		// count2.toString());
		// if (locale instanceof LongValue && cmpFlags instanceof LongValue &&
		// string1 instanceof LongValue
		// && count1 instanceof LongValue && string2 instanceof LongValue &&
		// count2 instanceof LongValue) {
		// register.mov("eax", new SymbolValue("api_eax"));
		// }
		...
		// System.out.println("Argument:" + hInstance.toString() + " " +
		// tName.toString() + " " + wParent.toString()
		// + " " + dialogFunc.toString() + initPar.toString());
		// if (hInstance instanceof LongValue && tName instanceof LongValue &&
		// wParent instanceof LongValue
		...
		// System.out.println("Argument:" + pathName.toString() + " " +
		// securityAttr.toString());
		// if (pathName instanceof LongValue && securityAttr instanceof
		// LongValue) {
		// register.mov("eax", new SymbolValue("api_eax"));
		// }
		...
		// System.out.println("Argument:" + eventAttr.toString() + " " +
		// manualReset.toString() + " "
		// + initialState.toString() + " " + pName.toString());
		// if (eventAttr instanceof LongValue && manualReset instanceof
		// LongValue && initialState instanceof LongValue
		...
		// System.out.println("Argument:" + appName.toString() + " " +
		// cmd.toString() + " " + pAttr.toString() + " "
		// + tAttr.toString() + inherritHandle.toString() + " " +
		// cFlags.toString() + " " + envi.toString()
		// + curDir.toString() + startupInfo.toString() + " " +
		// pInfo.toString());
		// if (appName instanceof LongValue && cmd instanceof LongValue && pAttr
		// instanceof LongValue
		// && tAttr instanceof LongValue && inherritHandle instanceof LongValue
		// && cFlags instanceof LongValue
		// && envi instanceof LongValue && curDir instanceof LongValue &&
		// startupInfo instanceof LongValue
		...
		// Value cFlags = stack.pop();
		// Value tID = stack.pop();
		// System.out.println("Argument:" + hProcess.toString() + " " +
		// tAttr.toString() + " " + stackSize.toString()
		// + " " + sAddr.toString() + parameter.toString() + " " +
		// cFlags.toString() + " " + tID.toString());
		// if (hProcess instanceof LongValue && tAttr instanceof LongValue &&
		// stackSize instanceof LongValue
		// && sAddr instanceof LongValue && parameter instanceof LongValue &&
		// cFlags instanceof LongValue
		...
		// System.out.println("Argument:" + exStyle.toString() + " " +
		// className.toString() + " " + winName.toString()
		// + " " + style.toString() + x.toString() + " " + y.toString() + " " +
		// width.toString() + " "
		// + height.toString() + " " + wParent.toString() + " " +
		// menu.toString() + " " + hinstance.toString()
		// + " " + param.toString());
		// if (exStyle instanceof LongValue && className instanceof LongValue &&
		// winName instanceof LongValue
		// && style instanceof LongValue && x instanceof LongValue && y
		// instanceof LongValue
		// && width instanceof LongValue && height instanceof LongValue &&
		// wParent instanceof LongValue
		// && menu instanceof LongValue && hinstance instanceof LongValue &&
		// param instanceof LongValue) {
		// register.mov("eax", new SymbolValue("api_eax"));
		// }
		...
		// System.out.println("Argument:" + " " + hDevice.toString() + " " +
		// controlCode.toString() + " "
		// + inBuffer.toString() + " " + inBufferSize.toString() + " " +
		// outBuffer.toString() + " "
		// + outBufferSize.toString() + " " + bytesReturned.toString() + " " +
		// overlapped.toString());
		// if (hDevice instanceof LongValue && controlCode instanceof LongValue
		// && inBuffer instanceof LongValue
		// && inBufferSize instanceof LongValue && outBuffer instanceof
		// LongValue
		// && outBufferSize instanceof LongValue && bytesReturned instanceof
		// LongValue
		...
		// System.out.println("Argument:" + " " + hinstance.toString() + " " +
		// tName.toString() + " "
		// + wParent.toString() + " " + dFunc.toString() + " " +
		// initPar.toString());
		// if (hinstance instanceof LongValue && tName instanceof LongValue &&
		// wParent instanceof LongValue
		...
		// System.out.println("Argument:" + " " + dateFormat.toString() + " " +
		// locale.toString() + " "
		// + flags.toString());
		// if (dateFormat instanceof LongValue && locale instanceof LongValue &&
		// flags instanceof LongValue) {
		// register.mov("eax", new SymbolValue("api_eax"));
		// }
		// } else if (funcName.startsWith("FileTimeToSystemTime")) {
		// Value fTime = stack.pop();
		// Value sTime = stack.pop();
		// System.out.println("Argument:" + " " + fTime.toString() + " " +
		// sTime.toString());
		...
		// if (hModule instanceof LongValue && name instanceof LongValue && type
		// instanceof LongValue) {
		// register.mov("eax", new SymbolValue("api_eax"));
		// }
		...
		// baseAddr.toString() + " "
		// + size.toString());
		// if (hProcess instanceof LongValue && baseAddr instanceof LongValue &&
		// size instanceof LongValue) {
		// register.mov("eax", new SymbolValue("api_eax"));
		// }
		...
		// Value wcx = stack.pop();
		// System.out.println("Argument:" + " " + hinst.toString() + " " +
		// strClass.toString() + " " + wcx.toString());
		// if (hinst instanceof LongValue && strClass instanceof LongValue &&
		// wcx instanceof LongValue) {
		// register.mov("eax", new SymbolValue("api_eax"));
		// }
		...
		// System.out.println("Argument:" + " " + locale.toString() + " " +
		// flags.toString() + " " + date.toString()
		// + " " + format.toString() + " " + datestr.toString() + " " +
		// chdate.toString());
		// if (locale instanceof LongValue && flags instanceof LongValue && date
		// instanceof LongValue
		// && format instanceof LongValue && datestr instanceof LongValue &&
		// chdate instanceof LongValue) {
		// register.mov("eax", new SymbolValue("api_eax"));
		// }
		...
		// + sectorpcluster.toString() + " "
		// + bytespsector.toString() + " " + nooffreecluster.toString() + " " +
		// totalnoofcluster.toString());
		// if (rootpathname instanceof LongValue && sectorpcluster instanceof
		// LongValue
		// && bytespsector instanceof LongValue && nooffreecluster instanceof
		// LongValue
		...
		// Value buffer = stack.pop();
		// Value size = stack.pop();
		// System.out.println("Argument:" + " " + name.toString() + " " +
		// buffer.toString() + " " + size.toString());
		// if (name instanceof LongValue && buffer instanceof LongValue && size
		// instanceof LongValue) {
		// register.mov("eax", new SymbolValue("api_eax"));
		// }
		...
		// System.out.println("Argument:" + " " + hfile.toString() + " " +
		// cTime.toString() + " " + laTime.toString()
		// + " " + lwTime.toString());
		// if (hfile instanceof LongValue && cTime instanceof LongValue &&
		// laTime instanceof LongValue
		...
		// System.out.println("Argument:" + " " + locale.toString() + " " +
		// ctype.toString() + " " + cdata.toString()
		// + " " + chdata.toString());
		// if (locale instanceof LongValue && ctype instanceof LongValue &&
		// cdata instanceof LongValue
		...
		// System.out.println("Argument:" + " " + msg.toString() +
		// wnd.toString() + " " + mFilterMin.toString() + " "
		// + mFilterMax.toString());
		// if (msg instanceof LongValue && wnd instanceof LongValue &&
		// mFilterMin instanceof LongValue
		...
		// System.out.println("Argument:" + " " + slongpath.toString() +
		// sshortpath.toString() + " "
		// + chbuffer.toString());
		...
		// srcstr.toString() + " "
		// + chsrc.toString() + " " + chartype.toString());
		// if (infotype instanceof LongValue && srcstr instanceof LongValue &&
		// chsrc instanceof LongValue
		...
		// System.out.println("Argument:" + " " + flg.toString() + " " +
		// bytes.toString());
		...
		// Value mii = stack.pop();
		// System.out.println("Argument:" + " " + menu.toString() + " " +
		// item.toString() + " " + byPos.toString()
		// + " " + mii.toString());
		// if (menu instanceof LongValue && item instanceof LongValue && byPos
		// instanceof LongValue
		...
		// Value lp = stack.pop();
		// Value ucb = stack.pop();
		// System.out.println("Argument:" + " " + lp.toString() + " " +
		// ucb.toString());
		...
		// Value dlg = stack.pop();
		// Value msg = stack.pop();
		// System.out.println("Argument:" + " " + dlg.toString() + " " +
		// msg.toString());
		...
		// System.out.println("Argument:" + " " + locale.toString() + " " +
		// flg.toString() + " " + srcstr.toString()
		// + " " + chsrc.toString() + " " + desrstr.toString() + " " +
		// chdest.toString());
		// if (locale instanceof LongValue && flg instanceof LongValue && srcstr
		// instanceof LongValue
		// && chsrc instanceof LongValue && desrstr instanceof LongValue &&
		// chdest instanceof LongValue) {
		// register.mov("eax", new SymbolValue("api_eax"));
		// }
		...
		// System.out.println("Argument:" + " " + hinstance.toString() + " " +
		// bitmapname.toString());
		// if (hinstance instanceof LongValue && bitmapname instanceof
		// LongValue) {
		// register.mov("eax", new SymbolValue("api_eax"));
		// }
		...
		// System.out.println("Argument:" + " " + hinstance.toString() + " " +
		// cursorname.toString());
		// if (hinstance instanceof LongValue && cursorname instanceof
		// LongValue) {
		// register.mov("eax", new SymbolValue("api_eax"));
		// }
		...
		// Value flg = stack.pop();
		// System.out.println("Argument:" + " " + mem.toString() + " " +
		// bytes.toString() + " " + flg.toString());
		// if (mem instanceof LongValue && bytes instanceof LongValue && flg
		// instanceof LongValue) {
		// register.mov("eax", new SymbolValue("api_eax"));
		// }
		...
		// System.out.println("Argument:" + " " + str1.toString() + " " +
		// str2.toString());
		...
		// System.out.println("Argument:" + " " + str1.toString() + " " +
		// str2.toString() + " " + maxlen.toString());
		// if (str1 instanceof LongValue && str2 instanceof LongValue && maxlen
		// instanceof LongValue) {
		// register.mov("eax", new SymbolValue("api_eax"));
		// }
		...
		// System.out.println("Argument:" + " " + cpage.toString() + " " +
		// flg.toString() + " " + multibstr.toString()
		// + " " + cmultibyte.toString() + " " + widecharstr.toString() + " " +
		// widechar.toString());
		// if (cpage instanceof LongValue && flg instanceof LongValue &&
		// multibstr instanceof LongValue
		// && cmultibyte instanceof LongValue && widecharstr instanceof
		// LongValue
		...
		// Value name = stack.pop();
		// System.out.println("Argument:" + " " + dAccess.toString() + " " +
		// iHandle.toString() + " "
		// + name.toString());
		// if (dAccess instanceof LongValue && iHandle instanceof LongValue &&
		// name instanceof LongValue) {
		// register.mov("eax", new SymbolValue("api_eax"));
		// }
		...
		// Value style = stack.pop();
		// System.out.println("Argument:" + " " + fName.toString() + " " +
		// reOpenBuff.toString() + " "
		// + style.toString());
		// if (fName instanceof LongValue && reOpenBuff instanceof LongValue &&
		// style instanceof LongValue) {
		// register.mov("eax", new SymbolValue("api_eax"));
		// }
		// } else if (funcName.startsWith("OpenEventA")) {
		// Value dAccess = stack.pop();
		...
		// Value pId = stack.pop();
		// System.out
		// .println("Argument:" + " " + dAccess.toString() + " " +
		// iHandle.toString() + " " + pId.toString());
		// if (dAccess instanceof LongValue && iHandle instanceof LongValue &&
		// pId instanceof LongValue) {
		// register.mov("eax", new SymbolValue("api_eax"));
		// }
		...
		// System.out.println("Argument:" + " " + hProc.toString() + " " +
		// bAddr.toString() + " " + buffer.toString()
		// + " " + size.toString() + " " + noofbyteread.toString());
		// if (hProc instanceof LongValue && bAddr instanceof LongValue &&
		// buffer instanceof LongValue
		...
		// System.out.println("Argument:" + " " + path.toString() + " " +
		// fName.toString() + " " + ext.toString()
		// + " " + bufferlen.toString() + " " + buffer.toString() + " " +
		// fPart.toString());
		// if (path instanceof LongValue && fName instanceof LongValue && ext
		// instanceof LongValue
		// && bufferlen instanceof LongValue && buffer instanceof LongValue &&
		// fPart instanceof LongValue) {
		// register.mov("eax", new SymbolValue("api_eax"));
		// }
		// } else if (funcName.startsWith("SetConsoleCtrlHandler")) {
		// Value hRoutine = stack.pop();
		// Value add = stack.pop();
		// System.out.println("Argument:" + " " + hRoutine.toString() + " " +
		// add.toString());
		...
		// System.out.println("Argument:" + " " + hthread.toString() + " " +
		// prior.toString());
		...
		// System.out.println("Argument:" + " " + wnd.toString() + " " +
		// idevent.toString() + " " + elapse.toString()
		// + " " + timerfunc.toString());
		// if (wnd instanceof LongValue && idevent instanceof LongValue &&
		// elapse instanceof LongValue
		...
		// Value resinfo = stack.pop();
		// System.out.println("Argument:" + " " + module.toString() + " " +
		// resinfo.toString());
		...
		// System.out.println("Argument:" + " " + systime.toString() + " " +
		// filetime.toString());
		...
		// System.out.println("Argument:" + " " + proc.toString() + " " +
		// exitcode.toString());
		...
		// Value classname = stack.pop();
		// Value hinstance = stack.pop();
		// System.out.println("Argument:" + " " + classname.toString() + " " +
		// hinstance.toString());
		...
		// System.out.println("Argument:" + " " + proc.toString() + " " +
		// addr.toString() + " " + size.toString()
		// + " " + alloctype.toString() + " " + protect.toString());
		// if (proc instanceof LongValue && addr instanceof LongValue && size
		// instanceof LongValue
		...
		// Value buffer = stack.pop();
		// Value len = stack.pop();
		// System.out.println("Argument:" + " " + addr.toString() + " " +
		// buffer.toString() + " " + len.toString());
		// if (addr instanceof LongValue && buffer instanceof LongValue && len
		// instanceof LongValue) {
		// register.mov("eax", new SymbolValue("api_eax"));
		// }
		...
		// multibstr.toString() + " "
		// + cmultibyte.toString() + " " + defaultchar.toString() + " " +
		// useddefaultchar.toString());
		// if (cpage instanceof LongValue && flg instanceof LongValue &&
		// widecharstr instanceof LongValue
		// && widechar instanceof LongValue && multibstr instanceof LongValue
		// && cmultibyte instanceof LongValue && defaultchar instanceof
		// LongValue
		...
		// System.out.println("Argument:" + " " + appname.toString() + " " +
		// keyname.toString() + " " + str.toString()
		// + " " + filename.toString());
		// if (appname instanceof LongValue && keyname instanceof LongValue &&
		// str instanceof LongValue
		...
		// if (proc instanceof LongValue && baddr instanceof LongValue && buffer
		// instanceof LongValue
	...
	// " " + x5 + " " + x6 + " " + x7);
	//
	// if (x1 instanceof LongValue && x2 instanceof LongValue && x3 instanceof
	// LongValue
	// && x4 instanceof LongValue && x5 instanceof LongValue && x6 instanceof
	// LongValue
	// && x7 instanceof LongValue) {
	// /*
	// * returnValue = APIHandler.getProcAddress( ((ValueLongExp)
	...
	// // String str = symbolValueMemoryOperand.getText(new
	// // X86MemoryOperand(DataType.INT32, t2));
	// System.out.println("Flag:" + t1 + ", Source:" + t2 + ", Message Field:" +
	// t3 + ", Language:" + t4
	// + ", Buffer:" + t5 + ", Size:" + t6 + ", Argument" + t7);
	// }
	// Value v = new SymbolValue("eax_" + funcName);
	...
	// memory.setMemoryValue(new X86MemoryOperand(DataType.INT32, t2), eax,
	// inst);
	// }
	//
	// } else if (funcName.startsWith("GetLastError")) {
	...
	// long disp = 4796200;
	// String commandLine = "C:/Windows/" + program.getFileName();
	// System.out.println("Argument MemoryOperand:" + disp + ", Command Line:" +
	// commandLine);
	// // memory.setText(new X86MemoryOperand(DataType.INT32, disp),
	// // commandLine);
	// memory.setText(new X86MemoryOperand(DataType.INT32, disp), "");
	...
	// long t2 = ((LongValue) x2).getValue();
	//
	// String searchName = memory.getText(new X86MemoryOperand(DataType.INT32,
	// t1));
	// System.out.println("Search File:" + searchName + ", Memory Operand:" +
	// t2);
	//
	...
	public boolean executeAPI(AbsoluteAddress address, String funcName, BPState curState, Instruction inst, int cond) {
		...
		// Instruction newInst;
		// if (curState.getEnvironement().getSystem().isInVirtualMemory() ==
		// true) {
