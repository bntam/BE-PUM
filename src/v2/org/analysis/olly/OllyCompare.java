...
public class OllyCompare {
    ...
    /*public boolean compare_bepum(Environment env, int id){
        boolean reg_compare = get(id).compareRegister(env.getRegister());
        boolean flag_compare = get(id).compareFlag(env.getFlag());
        boolean mem_compare = get(id).compareMemory(env.getMemory());
        boolean stack_compare = get(id).compareStack(env.getMemory());
