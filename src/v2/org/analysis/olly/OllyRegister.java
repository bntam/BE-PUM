...
public class OllyRegister {
    ...
    /*public boolean compare(Register regs){
        long eip_value = ((LongValue)regs.getRegisterValue("eip")).getValue();
        long eax_value = ((LongValue)regs.getRegisterValue("eax")).getValue();
        long ecx_value = ((LongValue)regs.getRegisterValue("ecx")).getValue();
        long edx_value = ((LongValue)regs.getRegisterValue("edx")).getValue();
        long ebx_value = ((LongValue)regs.getRegisterValue("ebx")).getValue();
        long esp_value = ((LongValue)regs.getRegisterValue("esp")).getValue();
        long ebp_value = ((LongValue)regs.getRegisterValue("ebp")).getValue();
        long esi_value = ((LongValue)regs.getRegisterValue("esi")).getValue();
        long edi_value = ((LongValue)regs.getRegisterValue("edi")).getValue();
        return (eip_value == this.eip) && (eax_value == this.eax) && (ecx_value == this.ecx)
                && (edx_value == this.edx) && (ebx_value == this.ebx) && (esp_value == this.esp)
                && (ebp_value == this.ebp) && (esi_value == this.esi) && (edi_value == this.edi);
    }*/
