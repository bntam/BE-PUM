...
public class OllyMemory {
    ...
    public boolean compare(Memory mems){
    ...
    public String compareMemory(OllyLoop l, Memory bpMem, long startAddr, long endaddr) {
        return compare(l.getMems(), bpMem, startAddr, endaddr);
    }

    private String compare(OllyMemory l, Memory bpMem, long startAddr, long endaddr) {
    ...
    public String compareStack(OllyLoop l, Memory m, long esp, long stackIndex) {
        return compare(l.getStack(), m, esp, esp + stackIndex);
    }
}
